package db.record.monitoring.listener;
...
import db.record.monitoring.writer.NotiFileWriter;
	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				String filePath = "./log/log_" + dt + ".log";
				NotiFileWriter.instance().write(filePath, msg);
